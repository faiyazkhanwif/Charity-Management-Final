...
//$sqln = "SELECT * FROM volinproject";
//$resultn = mysqli_query($conn,$sqln);
//$datan = mysqli_fetch_all($resultn,MYSQLI_ASSOC);
//$vnid = "";
...
$sql2 = "SELECT volinproject.task, volunteers.vol_id, volunteers.fullname, volunteers.nric FROM volinproject, volunteers WHERE volinproject.vol_id=volunteers.vol_id";
...
if (isset($_POST['remove'])) {
	$rmid = $_POST['remove'];
	$removesql = "DELETE FROM volinproject WHERE vol_id='$rmid'";
